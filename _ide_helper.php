...
namespace Illuminate\Database\Schema {
    ...
    class Blueprint {
        /**
         * @see \App\Providers\MacroServiceProvider::registerBlueprintMacros()
         * @param bool $nullable
         * @static
         */
        public static function organizationId($nullable = false)
        {
            return \Illuminate\Database\Schema\Blueprint::organizationId($nullable);
        }
        ...
        {
            return \Illuminate\Database\Schema\Blueprint::createdBy();
        }
        ...
        {
            return \Illuminate\Database\Schema\Blueprint::updatedBy();
        }
         ...
         * @static
         */
        public static function ulidPrimaryKey()
        {
            return \Illuminate\Database\Schema\Blueprint::ulidPrimaryKey();
        }
         ...
         * @static
         */
        public static function blamedBy()
        {
            return \Illuminate\Database\Schema\Blueprint::blamedBy();
        }
